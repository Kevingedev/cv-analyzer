...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <br><br><br>
        <div class="md:container md:mx-auto">
            ...
            <div class="grid grid-cols-1 place-content-center content-center  justify-center">
                <div>
                    <p class="animate__animated animate__backInUp animate__faster font-sans text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl text-center  font-bold text-cyan-300">
                        CV
                    </p>
                ...
                <form action="{{ route('upload') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="flex flex-col items-center justify-center">
                        <label class="flex items-center bg-cyan-50 text-cyan-700 rounded-full py-2 px-4 text-xs font-semibold hover:bg-cyan-100 cursor-pointer mt-6">
                        ...
                        <button 
                            ...
                            id="submit-button" 
                            type="submit" 
                            class="relative mt-4 inline-flex items-center justify-center p-0.5 mb-2 me-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-cyan-500 to-blue-500 group-hover:from-cyan-500 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-cyan-200 dark:focus:ring-cyan-800">
